...
export default function GuestsEdit({
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit', href: `/weddings/${wedding.id}/guests/${guest.id}/edit` },
    ];
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        group: guest.group || '',
        side: guest.side || ('' as 'bride' | 'groom' | 'both' | ''),
        relationship: guest.relationship || '',
        rsvp_status: guest.rsvp_status,
        attending_ceremony: guest.attending_ceremony,
        attending_reception: guest.attending_reception,
        ...
        table_id: guest.table_id?.toString() || '',
        seat_number: guest.seat_number?.toString() || '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/weddings/${wedding.id}/guests/${guest.id}`);
    };

    return (
        <WeddingLayout breadcrumbs={breadcrumbs} wedding={wedding}>
            <Head title={`${wedding.title} - Edit ${guest.full_name}`} />

            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="icon" asChild>
                        <Link href={`/weddings/${wedding.id}/guests/${guest.id}`}>
                            ...
                            <div className="grid gap-4 sm:grid-cols-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        type="number"
                                        min="0"
                                        max={data.plus_one_allowed}
                                        value={data.plus_one_count}
                                        onChange={(e) =>
                                            setData(
                                                'plus_one_count',
                                                parseInt(e.target.value) || 0
